...
class OllamaRAG:
    ...
    def query(self, question: str, k: int = 3, temperature: float = 0.7, max_tokens: int = 512) -> Dict[str, Any]:
        ...
        print(f"🎯 Chunk distances: {distances}")
    ...
    கேள்வி விவசாயம் தொடர்பானதா இல்லையா என்று முதலில் தீர்மானிக்கவும்.

    விவசாயம் தொடர்பானது என்றால்:
    கீழே உள்ள தகவல்களை பயன்படுத்தி தமிழில் 3-4 வரிகளில் நேரடியாக பதில் மட்டும் சொல்லுங்கள்.

    விவசாயம் தொடர்பில்லாதது என்றால்:
    உங்கள் சொந்த அறிவை பயன்படுத்தி தமிழில் நேரடியாக பதில் மட்டும் சொல்லுங்கள்.

    முக்கியம்:
    - "YES", "NO", "விவசாயம் தொடர்பானது", "தொடர்பில்லாதது" என்று எழுதாதீர்கள்
    - QUESTION, ANSWER, METADATA என்று எழுதாதீர்கள்
    - நேரடியாக பதிலை மட்டும் எழுதுங்கள்
    ...
    Determine if this is agriculture related or not.

    If agriculture related:
    Use the context and answer directly in Tamil script in 3-4 lines.
    ...
    - Do NOT include any prefixes or classifications
    ...
    Determine if the question is agriculture related or not.

    If agriculture related:
    Use the context below and answer directly in 3-4 clear lines.

    If NOT agriculture related:
    Answer directly from your own knowledge in 2-3 lines.
